...
#cmo.setCredential('wlsbind')
#cd('/SecurityConfiguration/base_domain/Realms/myrealm')
#set('AuthenticationProviders',jarray.array([ObjectName('Security:Name=myrealmLDAP-AD'), ObjectName('Security:Name=myrealmDefaultAuthenticator'), ObjectName('Security:Name=myrealmDefaultIdentityAsserter')], ObjectName))
